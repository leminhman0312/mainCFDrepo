...
\usepackage{hyperref}
\usepackage{minted}
\usepackage[margin=1in, truedimen]{geometry} \usepackage{graphicx} \usepackage{amssymb}
...
\label{sec:orga98cf3f}
\subsection{Generic Conservation Equation}
\label{sec:orgd81e12c}
...
\end{center}
\subsection{Implemenation: \href{1D\_heat\_diffusion.py}{Python code}}
\label{sec:orgafd567c}
\clearpage
\section{TRANSIENT 1D HEAT DIFFUSION}
\label{sec:orgc511ba8}
\subsection{Problem Definition}
\label{sec:orgc606890}
...
\label{sec:org3addc49}
\subsubsection{General idea}
\label{sec:org833d7fc}
...
\label{sec:org0a64cfd}
\clearpage
\section{ONE-DIMENSIONAL CONVECTION OF A SCALAR}
\label{sec:org5cc7574}
\subsection{Problem Definition}
\label{sec:orgf6a43fb}
