...
\usepackage[scaled=1.00]{helvet} \renewcommand\familydefault{\sfdefault}
...
\label{sec:org0d03bc0}
\subsubsection{General idea}
\label{sec:orgd7fd795}
...
\label{sec:org6a6caa9}

\subsubsection{Power Law Scheme}
\label{sec:org7aa65b3}
